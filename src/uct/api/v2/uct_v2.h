...
enum uct_perf_attr_field {
    ...
    /** Enable @ref uct_perf_attr_t::operation_size */
    UCT_PERF_ATTR_FIELD_OPERATION_SIZE     = UCS_BIT(15),

    /** Enable @ref uct_perf_attr_t::local_host_memory_class */
    UCT_PERF_ATTR_FIELD_LOCAL_HOST_MEMORY_CLASS = UCS_BIT(16),

    /** Enable @ref uct_perf_attr_t::remote_host_memory_class */
    UCT_PERF_ATTR_FIELD_REMOTE_HOST_MEMORY_CLASS = UCS_BIT(17)
};
...
typedef struct {
    ...
    /**
     * Estimated payload size for the queried operation, in bytes.
     * This caller-provided input field is ignored when omitted.
     */
